...
WebUI.callTestCase(findTestCase('QuanLyTaiKhoan/DangNhap/dang nhap tai khoan test the yeu thich'), [:], FailureHandling.STOP_ON_FAILURE)

Mobile.startExistingApplication(GlobalVariable.appID, FailureHandling.STOP_ON_FAILURE)

Mobile.tap(findTestObject('ObjectTangGoiCloud/Tab_Thiet_Bi'), 30)
...
Mobile.verifyElementText(findTestObject('ObjectTangGoiCloud/txt_sdt_tang_goi_cloud'), '0866617796')
