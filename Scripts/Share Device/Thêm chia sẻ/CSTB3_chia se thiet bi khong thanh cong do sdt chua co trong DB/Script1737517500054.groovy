...
Mobile.setText(findTestObject('ObjectManThietBi/txtbox_nhap_so_dien_thoai'), '0304050607', 0)

Mobile.tap(findTestObject('ObjectManThietBi/btn_tiep_tuc_nhap_so_dien_thoai'), 0)

Mobile.verifyElementVisible(findTestObject('ObjectChiaSeThietBi/popup_tk_khong_ton_tai'), 0)

Mobile.tap(findTestObject('ObjectChiaSeThietBi/btn_OK_popup_tai_khoan_khong_ton_tai'), 0)
