...
Mobile.verifyElementVisible(findTestObject('ObjectChiaSeThietBi/title_thiet_bi_da_chap_nhan (1)'), 0)
...
Mobile.verifyElementNotExist(findTestObject('ObjectChiaSeThietBi/Huy chia se/icon_camera_nhan_chia_se'), 0)
