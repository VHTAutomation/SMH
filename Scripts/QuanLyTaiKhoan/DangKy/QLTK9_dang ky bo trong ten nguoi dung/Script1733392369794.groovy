...
Mobile.clearText(findTestObject('ObjectDangNhap/ObjectManDangKy/txtfield_nhap_ten_nguoi_dung'), 0)

Mobile.hideKeyboard()

Mobile.verifyElementText(findTestObject('ObjectDangNhap/ObjectManDangKy/txt_vui_long_nhap_ten_nguoi_dung (1)'), 'Vui lòng nhập tên người dùng')
