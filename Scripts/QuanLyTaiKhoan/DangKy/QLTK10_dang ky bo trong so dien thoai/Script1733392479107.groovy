...
Mobile.clearText(findTestObject('ObjectDangNhap/ObjectManDangKy/txtfield_so_dien_thoai (1)'), 0)
...
Mobile.verifyElementText(findTestObject('ObjectDangNhap/ObjectManDangKy/txt_vui_long_nhap_so_dien_thoai_cua_ban (1)'), 'Vui lòng nhập số điện thoại của bạn')
