...
<<<<<<< HEAD
Mobile.verifyElementVisible(findTestObject('ObjectCaiDatCamera/ObjectLuuTruCloud/Dich vu Cloud/dich_vu_cloud_popup_xac_nhan_huy_gia_han'), 0)
=======
...
<<<<<<< HEAD
Mobile.tap(findTestObject('ObjectCaiDatCamera/ObjectLuuTruCloud/btn_xac_nhan_gia_han'), 0)
=======
...
<<<<<<< HEAD
Mobile.verifyElementText(findTestObject('ObjectCaiDatCamera/ObjectLuuTruCloud/text_Tat_thanh_toan_tu_dong_thanh_cong'), 'Tắt thanh toán tự động thành công')
=======
